...
SERIAL_EXPECTED = [
    DataPackage(
        ...
        raw_pose=Quaternion(w=-0.8855273723602295, x=-0.2154131978750229, y=-0.048614680767059326, z=-0.4046018123626709),
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8852854371070862, x=-0.21469898521900177, y=-0.05200347304344177, z=-0.4050891697406769),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8847295641899109, x=-0.21519680321216583, y=-0.05288498103618622, z=-0.4059247076511383),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.884261429309845, x=-0.21617817878723145, y=-0.053554389625787735, z=-0.40633517503738403),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8838305473327637, x=-0.21757543087005615, y=-0.05429384112358093, z=-0.40642887353897095),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8832838535308838, x=-0.21905049681663513, y=-0.05470965802669525, z=-0.40676891803741455),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8826923966407776, x=-0.22027578949928284, y=-0.05465429276227951, z=-0.4073982238769531),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8820538520812988, x=-0.22116819024085999, y=-0.05410676449537277, z=-0.4083695411682129),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=-0.8807398676872253, x=-0.2222874015569687, y=-0.049198102205991745, z=-0.4112088680267334),
        current_pose=Quaternion(
...
BLUETOOH_EXPECTED = [
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=0.9531991481781006, x=0.1342150717973709, y=-0.24593251943588257, z=-0.09768593311309814),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=0.9515230059623718, x=0.13810229301452637, y=-0.24748870730400085, z=-0.10444533824920654),
        current_pose=Quaternion(
    ...
    DataPackage(
        ...
        mag=Point3d(x=0.0, y=0.0, z=-0.0),
        raw_pose=Quaternion(w=0.9500142931938171, x=0.1318855732679367, y=-0.2588249146938324, z=-0.09857095777988434),
        current_pose=Quaternion(w=0.9500142931938171, x=0.1318855732679367, y=-0.2588249146938324, z=-0.09857095777988434),
